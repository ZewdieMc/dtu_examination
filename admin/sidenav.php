...
<li><a href="<?php echo SITEURL?>/admin/index.php?page=faculty"><i class="fa fa-users"></i>Users</a>

<li>

<a href="#"><i class="fa fa-eye"></i>View<span class="fa arrow"></span></a>
<ul class="nav nav-third-level">
<li class="<?php echo SITEURL?>/admin/index.php?page=faculty"><a href="adddepartment.php"><i class="fa fa-pencil"></i>Exams</a></li>
<li><a href="addcollege.php"><i class="fa fa-file-text"></i>Report</a></li>
