        ...
        <ul class="nav metismenu" id="side-menu">
            <li class="nav-header">
                <div class="dropdown profile-element"> <span>
                        ...
                        <img class='img-circle' alt="image" style="width:80px;height:80px;" ; src="<?php echo SITEURL; ?>images/teacher.jpg" /><span></span>
                    </span>
                    ...
                    <ul class="dropdown-menu animated fadeInRight m-t-xs">
                        <li><a href="<?php echo SITEURL; ?>teacher/index.php?page=change_password">Change Password</a></li>
                        <li class="divider"></li>
                        <li><a href="<?php echo SITEURL; ?>teacher/index.php?page=change_profile">Change Profile</a></li>
                        <li class="divider"></li>
                        <li><a href="<?php echo SITEURL; ?>teacher/index.php?page=logout">Logout</a></li>
                    </ul>
                </div>
            </li>
            <li>
                ...
                <ul class="nav nav-second-level collapse">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-third-level">
                            ...
                            ?>
                                <li><a href="<?php echo SITEURL ?>teacher/index.php?page=student_result&exam_id=<?php echo $row['exam_id']?>"><i class="fa fa-pencil"></i><?php echo $row['course_name']; ?></a></li>
                            <?php
                            }
                            ?>
                        </ul>
