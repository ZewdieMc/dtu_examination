        ...
        <ul class="nav metismenu" id="side-menu">
            <li class="nav-header">
                <div class="dropdown profile-element"> <span>
                    ...
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                        <span class="clear"> <span class="block m-t-xs"> <strong class="font-bold">Faculty Name</strong>
            ...
            <li>
                ...
                <ul class="nav nav-second-level collapse">
                    <li><a href="<?php echo SITEURL ?>faculty/index.php?page=faculty"><i class="fa fa-building-o"></i>Department </a>
                    <li><a href="<?php echo SITEURL ?>faculty/index.php?page=deans"><i class="fa fa-users"></i>Users</a>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-third-level">
                            ...
                            <li><a href="<?php echo SITEURL ?>faculty/index.php?page=faculty"><i class="fa fa-file-text"></i>Report</a></li>
